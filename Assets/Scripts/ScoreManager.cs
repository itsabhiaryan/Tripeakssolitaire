...
{
    static private ScoreManager Instance;//singleton 
    ...
    public void Awake()
    {
        if (Instance == null)
        {
            Instance = this;//Set the private singleton
        }
        else
        {
    ...
    static public int CHAIN { get { return Instance.chain; } }
    static public int SCORE { get { return Instance.score; } } 
    static public int SCORE_RUN { get { return Instance.scoreRun; } }
